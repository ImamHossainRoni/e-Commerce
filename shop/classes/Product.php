...
class Product
{
	...
	public function getLatestIphone(){
		$sql = "SELECT * FROM tbl_product WHERE brandId='10' ORDER BY pid DESC LIMIT 1";
		$result = $this->db->select($sql);
		return $result;
	}
	//load product brand wise..Samsung
	public function getLatestSamsung(){
		$sql = "SELECT * FROM tbl_product WHERE brandId='11' ORDER BY pid DESC LIMIT 1";
		$result = $this->db->select($sql);
		return $result;
	}
	...
	public function getLatestCanon(){
		$sql = "SELECT * FROM tbl_product WHERE brandId='14' ORDER BY pid DESC LIMIT 1";
		$result = $this->db->select($sql);
		return $result;
	}
